        ...
        <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
            ...
            <div class="w-full">
                <input type="text" placeholder="Digite a sua tarefa" v-model="title" @keyup.enter="onTitleChange"
                    :class="[{ 'line-through': isCompleted }, 'bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3']">
            </div>

            <div class="ml-auto flex items-center justify-center">
                <button class="focus:outline-none" @click="onDeleteClick">
...
export default {
    ...
    //         this.updateTodo() // update via v-model
    //     },
    //     onCheckClick() {
